        ...
        foreach (static::$objet::getAllObjets() as $objet) {
            ...
            if (Session::adminConnected()) {
                if (static::$objet == "Auteur") {
                    $tableauAffichage[] = "<div class='ligne'>
                        <div>
                    ...
                    $tableauAffichage[] = "<div class='ligne'>
<div>[N°<strong>" . $numObjet . "</strong>] " . $objet->afficher() . "</div><div> $lienLivre&nbsp;&nbsp;$lienDetails&nbsp;$lienEdit&nbsp;$lienDelete</div> </div>";
                } else {
                    if (static::$objet == "Adherent" && Session::getUserLoggedID() == $objet->get('login')) {
                        $tableauAffichage[] = "<div class='ligne'><div>[N°<strong>" . $numObjet . "</strong>] " . $objet->afficher() . "</div><div>$lienEdit&nbsp;$lienDetails</div> </div>";
                    } else if (static::$objet != 'Adherent') {
    ...
    public static function addObjet()
    {
        if (Session::adminConnected()){
            ...
            // TODO: faire une page 403 / Forbidden
